...
//						SoundManagerScript.winAudioSource.Play ();
			...
			if (totalYellowInHouse > 3 && totalRedInHouse < 4 && totalBlueInHouse < 4 && totalGreenInHouse < 4 && playerTurn == "                                                                                                                                                     ") 
				{
					if (!yellowScreen.activeInHierarchy) {
//						SoundManagerScript.winAudioSource.Play ();
					}
...
//						SoundManagerScript.winAudioSource.Play ();
		...
		if (currentPlayerName.Contains ("RED PLAYER")) 
		{
			...
			print ("currentPlayer:" + RedPlayerI_Script.redPlayerI_ColName);
	...
	IEnumerator PlayersNotInitialized()
	{
		...
		{
		case "RED": 	
			print ("CONDITION FOR BORDER GLOW");
			//==================== CONDITION FOR BORDER GLOW ========================
			print("redMovementBlocks.Count - redPlayerI_Steps:"+(redMovementBlocks.Count - redPlayerI_Steps)+" redMovementBlocks.Count - redPlayerI_Steps:"+(redMovementBlocks.Count - redPlayerI_Steps));
			...
			{
				print ("Border glow of 1st red player new:");
			   ...
			   !redPlayerIII_Border.activeInHierarchy && !redPlayerIV_Border.activeInHierarchy) 
			{
				...
				switch (MainMenuScript.howManyPlayers) {
				case 2:
					print ("PLAYERS DON'T HAVE ANY MOVES ,SWITCH TO NEXT TURN:");
					playerTurn = "GREEN";
					InitializeDice ();
					break;
	...
	public void redPlayerI_UI()
	{
		...
		if (playerTurn == "RED" && (redMovementBlocks.Count - redPlayerI_Steps) > selectDiceNumAnimation) // 4 > 4
		{
			...
			else 
			{
				...
				{
					print ("DiceRollButton.interactable:" + DiceRollButton.interactable);
					print ("First move of RedPlayerI");
					Vector3[] redPlayer_Path = new Vector3[selectDiceNumAnimation];
...
//		print ("redPlayerI_Steps" + redPlayerI_Steps);
	} 
	*/
}